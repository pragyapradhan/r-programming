...
FTAPG <- round(FreeThrowsAttempts/Games)
FTAPG
myplot(FTAPG)
...
AFT<- round(FreeThrows/FreeThrowsAttempts,2)
AFT
myplot(AFT)
...
#3.Player playing style( Pattern (2 vs 3 points prefernce) excluding free throws

PPS <- round((Points - FreeThrows)/FieldGoals,3)
PPS
myplot(PPS)



#Visualising the plots and creating function
